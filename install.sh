...
# 수정 1: conda create 명령어에 python=3.7 명시
...
echo ""
echo ""
# 수정 2: Ubuntu 22.04 호환성을 위한 gcc-8 설치
echo "****************** Installing compatible compiler (gcc-8) for Ubuntu 22.04 ******************"
conda install -y -c conda-forge gcc=8 gxx=8

echo ""
echo ""
echo "****************** Installing pytorch with cuda10 ******************"
# 수정 3: PyTorch 1.4.0 및 CUDA 10.1 버전 고정
